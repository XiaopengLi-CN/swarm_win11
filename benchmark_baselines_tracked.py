...
# -*- coding: utf-8 -*-
"""
benchmark_baselines_tracked.py - 带代码跟踪的基准测试脚本
"""
...
import sys
sys.path.append('.')
from code_tracker import tracker, track_function, auto_track_modules
...
if __name__ == '__main__':
    ...
    print("代码跟踪完成！请查看 benchmark_baselines.txt 文件")
