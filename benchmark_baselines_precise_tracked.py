...
# -*- coding: utf-8 -*-
"""
benchmark_baselines_precise_tracked.py - 使用精确跟踪器的基准测试脚本
"""
...
import sys
sys.path.append('.')
from precise_code_tracker import tracker, track_function, auto_track_all_modules
...
if __name__ == '__main__':
    ...
    print(f"涉及文件数量: {len(tracker.tracked_files)}")
    print(f"涉及函数数量: {len(tracker.tracked_functions)}")
    print("详细报告已保存到: precise_code_analysis.txt")
    print("JSON数据已保存到: code_analysis_data.json")
